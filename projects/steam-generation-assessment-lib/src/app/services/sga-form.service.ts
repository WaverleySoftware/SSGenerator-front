  ...
  private createInputParamsForm(): TForm<InputParametersTFormInterface> {
    const data: InputParametersCreateFormInterface = {
      ...
      benchmarkInputs: {
        ...
        o2ScavengingChemicalsCostSavings: [null, null, validateBenchmarkInput(this.apiService)],
        ...
        percentOfEffluentBoilerHouseWater: [null, [
          Validators.required,
          Validators.max(100),
          Validators.min(0),
        ], validateBenchmarkInput(this.apiService)]
      }
    };

...
/**
 * The CleanSteamGeneratorPricing model.
 */
export class EasiHeatPricing {  
  /**
   ...
   */
  pricingOptions: EasiHeatPricingOption[];
...
export class EasiHeatPricingOption {
  /**
...
export class EasiHeatPricingOutput {

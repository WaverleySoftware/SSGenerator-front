...
import { CleanSteamGeneratorFBMiniValidationErrorMessage } from "./cleanSteamGeneratorFBMiniInputValidation.model";

import { CleanSteamGeneratorFBMiniPricing, CleanSteamGeneratorFBMiniBOMPriceOutput, BOMItem } from "./cleanSteamGeneratorFBMiniPricingOptions.model";
...
@Component({
  selector: 'clean-steam-generator-fb-mini',
...
export class CleanSteamGeneratorFBMiniComponent extends BaseSizingModule implements OnInit, IGenericChanges {
  @BlockUI('conditions-section') blockUi: NgBlockUI;
  private blockUiTimeOut;
  readonly moduleGroupId: number = 13;
  // ModuelGroup contains both:
  // ModuleGroupId = 13, ModuleId = 11	CSG HalfPipe Product Sizing
  // ModuleGroupId = 13, ModuleId = 12	CSG FBMini Product Sizing
  readonly moduleName: string = "Clean Steam Generator FB"; // CLEAN_STEAM_GENERATOR_FB for bothe FBMini and HalfPipe sizing
  ...
  public plantSteamValidationErrorMessage: CleanSteamGeneratorFBMiniValidationErrorMessage;
  public cleanSteamValidationErrorMessage: CleanSteamGeneratorFBMiniValidationErrorMessage;
  public feedwaterPressureValidationErrorMessage: CleanSteamGeneratorFBMiniValidationErrorMessage;
  public feedwaterTemperatureValidationErrorMessage: CleanSteamGeneratorFBMiniValidationErrorMessage;
  public cleanSteamFlowrateValidationErrorMessage: CleanSteamGeneratorFBMiniValidationErrorMessage;
  public tdsBlowdownValidationErrorMessage: CleanSteamGeneratorFBMiniValidationErrorMessage;

  public pressureDifferentialErrorMessage: string;

  csgProcessConditions: CleanSteamGeneratorFBMiniProcessConditions;

  public csgOutputData: CleanSteamGeneratorFBMiniOutput[] = [];
  public selectedOutputData: CleanSteamGeneratorFBMiniOutput[] = [];

  public csgPricing: CleanSteamGeneratorFBMiniPricing;
  public csgPricingOutputData: CleanSteamGeneratorFBMiniPricingOutput;
  public csgBOMOutputData: CleanSteamGeneratorFBMiniBOMPriceOutput;
  ...
  /*
   * CSG-FB 400 => CSG-FB 020
   * CSG-FB 050 => CSG-FB 050
   * CSG-FB 601 => CSG-FB 110
   * CSG-FB 602 => CSG-FB 160
   */
  private hashTable = [
    {
      name: 'CSG-FB 020',
      design_Code: 'CSG_FB_020_Design_Code',
      shell_Type: 'CSG_FB_020_Shell_Type',
      valve_Actuation: 'CSG_FB_020_Valve_Actuation',
      control: 'CSG_FB_020_Control',
      communication_Interface: 'CSG_FB_020_Communication_Interface',
      frame_And_Cabinet: 'CSG_FB_020_Frame_And_Cabinet',
      control_Panel_Location: 'CSG_FB_020_Control_Panel_Location',
      insulation: 'CSG_FB_020_Insulation',
      wheels_And_Feet: 'CSG_FB_020_Wheels_And_Feet',
      plant_Steam_Inlet_Shut_Off_Valve: 'CSG_FB_020_Plant_Steam_Inlet_Shut_Off_Valve',
      plant_Steam_Line_Trapping: 'CSG_FB_020_Plant_Steam_Line_Trapping',
      tds_Control_System: 'CSG_FB_020_TDS_Control_System',
      sample_Cooler: 'CSG_FB_020_Sample_Cooler',
      independent_Low_Level_Alarm: 'CSG_FB_020_Independent_Low_Level_Alarm',
      feedwater_Pre_Heating_Degassing: 'CSG_FB_020_Feedwater_Pre_Heating_Degassing',
      intelligent_Diagnostics: 'CSG_FB_020_Intelligent_Diagnostics',
      clean_Steam_Outlet_Shut_Off_Valve: 'CSG_FB_020_Clean_Steam_Outlet_Shut_Off_Valve',
      test_And_Certification: 'CSG_FB_020_Test_And_Certification',
      level_Indicator: 'CSG_FB_020_Level_Indicator',

      feedwater_Pressurisation: 'CSG_FB_020_Feedwater_Pressurisation'
    },
    {
      name: 'CSG-FB 050',
      design_Code: 'CSG_FB_050_Design_Code',
      shell_Type: 'CSG_FB_050_Shell_Type',
      valve_Actuation: 'CSG_FB_050_Valve_Actuation',
      control: 'CSG_FB_050_Control',
      communication_Interface: 'CSG_FB_050_Communication_Interface',
      frame_And_Cabinet: 'CSG_FB_050_Frame_And_Cabinet',
      control_Panel_Location: 'CSG_FB_050_Control_Panel_Location',
      insulation: 'CSG_FB_050_Insulation',
      wheels_And_Feet: 'CSG_FB_050_Wheels_And_Feet',
      plant_Steam_Inlet_Shut_Off_Valve: 'CSG_FB_050_Plant_Steam_Inlet_Shut_Off_Valve',
      plant_Steam_Line_Trapping: 'CSG_FB_050_Plant_Steam_Line_Trapping',
      tds_Control_System: 'CSG_FB_050_TDS_Control_System',
      sample_Cooler: 'CSG_FB_050_Sample_Cooler',
      independent_Low_Level_Alarm: 'CSG_FB_050_Independent_Low_Level_Alarm',
      feedwater_Pre_Heating_Degassing: 'CSG_FB_050_Feedwater_Pre_Heating_Degassing',
      intelligent_Diagnostics: 'CSG_FB_050_Intelligent_Diagnostics',
      clean_Steam_Outlet_Shut_Off_Valve: 'CSG_FB_050_Clean_Steam_Outlet_Shut_Off_Valve',
      test_And_Certification: 'CSG_FB_050_Test_And_Certification',
      level_Indicator: 'CSG_FB_050_Level_Indicator',

      feedwater_Pressurisation: 'CSG_FB_050_Feedwater_Pressurisation'
    },
    {
      name: 'CSG-FB 110',
      design_Code: 'CSG_FB_110_Design_Code',
      shell_Type: 'CSG_FB_110_Shell_Type',
      valve_Actuation: 'CSG_FB_110_Valve_Actuation',
      control: 'CSG_FB_110_Control',
      communication_Interface: 'CSG_FB_110_Communication_Interface',
      frame_And_Cabinet: 'CSG_FB_110_Frame_And_Cabinet',
      control_Panel_Location: 'CSG_FB_110_Control_Panel_Location',
      insulation: 'CSG_FB_110_Insulation',
      wheels_And_Feet: 'CSG_FB_110_Wheels_And_Feet',
      plant_Steam_Inlet_Shut_Off_Valve: 'CSG_FB_110_Plant_Steam_Inlet_Shut_Off_Valve',
      plant_Steam_Line_Trapping: 'CSG_FB_110_Plant_Steam_Line_Trapping',
      tds_Control_System: 'CSG_FB_110_TDS_Control_System',
      sample_Cooler: 'CSG_FB_110_Sample_Cooler',
      independent_Low_Level_Alarm: 'CSG_FB_110_Independent_Low_Level_Alarm',
      feedwater_Pre_Heating_Degassing: 'CSG_FB_110_Feedwater_Pre_Heating_Degassing',
      intelligent_Diagnostics: 'CSG_FB_110_Intelligent_Diagnostics',
      clean_Steam_Outlet_Shut_Off_Valve: 'CSG_FB_110_Clean_Steam_Outlet_Shut_Off_Valve',
      test_And_Certification: 'CSG_FB_110_Test_And_Certification',
      level_Indicator: 'CSG_FB_110_Level_Indicator',

      feedwater_Pressurisation: 'CSG_FB_110_Feedwater_Pressurisation'
    },
    {
      name: 'CSG-FB 160',
      design_Code: 'CSG_FB_160_Design_Code',
      shell_Type: 'CSG_FB_160_Shell_Type',
      valve_Actuation: 'CSG_FB_160_Valve_Actuation',
      control: 'CSG_FB_160_Control',
      communication_Interface: 'CSG_FB_160_Communication_Interface',
      frame_And_Cabinet: 'CSG_FB_160_Frame_And_Cabinet',
      control_Panel_Location: 'CSG_FB_160_Control_Panel_Location',
      insulation: 'CSG_FB_160_Insulation',
      wheels_And_Feet: 'CSG_FB_160_Wheels_And_Feet',
      plant_Steam_Inlet_Shut_Off_Valve: 'CSG_FB_160_Plant_Steam_Inlet_Shut_Off_Valve',
      plant_Steam_Line_Trapping: 'CSG_FB_160_Plant_Steam_Line_Trapping',
      tds_Control_System: 'CSG_FB_160_TDS_Control_System',
      sample_Cooler: 'CSG_FB_160_Sample_Cooler',
      independent_Low_Level_Alarm: 'CSG_FB_160_Independent_Low_Level_Alarm',
      feedwater_Pre_Heating_Degassing: 'CSG_FB_160_Feedwater_Pre_Heating_Degassing',
      intelligent_Diagnostics: 'CSG_FB_160_Intelligent_Diagnostics',
      clean_Steam_Outlet_Shut_Off_Valve: 'CSG_FB_160_Clean_Steam_Outlet_Shut_Off_Valve',
      test_And_Certification: 'CSG_FB_160_Test_And_Certification',
      level_Indicator: 'CSG_FB_160_Level_Indicator',

      feedwater_Pressurisation: 'CSG_FB_160_Feedwater_Pressurisation'
    }
  ];
  ...
  selectedRow: CleanSteamGeneratorFBMiniOutput;
  ...
  constructor(private activatedRoute: ActivatedRoute, private projectsJobsService: ProjectsJobsService, private fb: FormBuilder,
    private cleanSteamGeneratorFBMiniService: CleanSteamGeneratorFBMiniService, private modulePreferenceService: ModulePreferenceService,
    private translationService: TranslationService, private preferenceService: PreferenceService, private docGenService: DocGenService, private csgFbMiniDocGenService: csgFbMiniDocGenService, private translatePipe: TranslatePipe,
    ...
    // Initialize.
    this.csgProcessConditions = new CleanSteamGeneratorFBMiniProcessConditions();

    this.csgPricing = new CleanSteamGeneratorFBMiniPricing();
    this.csgPricingOutputData = new CleanSteamGeneratorFBMiniPricingOutput();
    this.csgBOMOutputData = new CleanSteamGeneratorFBMiniBOMPriceOutput();


    // Validation messages.
    this.plantSteamValidationErrorMessage           = new CleanSteamGeneratorFBMiniValidationErrorMessage();
    this.cleanSteamValidationErrorMessage           = new CleanSteamGeneratorFBMiniValidationErrorMessage();
    this.feedwaterPressureValidationErrorMessage    = new CleanSteamGeneratorFBMiniValidationErrorMessage();
    this.feedwaterTemperatureValidationErrorMessage = new CleanSteamGeneratorFBMiniValidationErrorMessage();
    this.cleanSteamFlowrateValidationErrorMessage   = new CleanSteamGeneratorFBMiniValidationErrorMessage();
    this.tdsBlowdownValidationErrorMessage          = new CleanSteamGeneratorFBMiniValidationErrorMessage();
  ...
  getModulePreferenceValues() {
    ...
    var manufacturerPref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniManufacturer");
    if (manufacturerPref) {
    ...
    var basePricePref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniBasePriceOption");
    if (basePricePref) {
      this.basePriceOption = +basePricePref.value;
    }
    var localRecommendedSalesPricePref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniLocalRecommendedSalesPriceOption");
    if (localRecommendedSalesPricePref) {
      this.localRecommendedSalesPriceOption = +localRecommendedSalesPricePref.value;
    }
    var landedCostIncreasePref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniLandCostIncrease");
    if (landedCostIncreasePref) {
      this.landedCostIncreaseFactor = (100 + (+landedCostIncreasePref.value)) / 100;
    }
    var deliveryCostPref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniDeliveryCost");
    if (deliveryCostPref) {
      this.deliveryCost = +deliveryCostPref.value;
    }

    var commissionCostCostPref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniCommission");
    if (commissionCostCostPref) {
      this.commissionCost = +commissionCostCostPref.value;
    }
    var oneYearWarrantyCostPref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniYearOne");
    if (oneYearWarrantyCostPref) {
      this.oneYearWarrantyCost = +oneYearWarrantyCostPref.value;
    }
    var twoYearWarrantyCostPref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniYearTwo");
    if (twoYearWarrantyCostPref) {
      this.twoYearWarrantyCost = +twoYearWarrantyCostPref.value;
    }
    var threeYearWarrantyCostPref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniYearThree");
    if (threeYearWarrantyCostPref) {
      this.threeYearWarrantyCost = +threeYearWarrantyCostPref.value;
    }

    var manufacturerCurrencyPref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniManufacturerCurrency");
    if (manufacturerCurrencyPref) {
      this.manufacturerCurrencyId = +manufacturerCurrencyPref.value;
    }
    var sellingCurrencyPref = this.modulePreferenceService.getModulePreferenceByName("CSGFBMiniSellingCurrency");
  ...
  loadJob() {
    try {
      ...
      if (this.loadedJobSizingData.sizingOutput.outputGrid != null &&
        ...
        this.csgOutputData = new Array<CleanSteamGeneratorFBMiniOutput>();

        var row = new CleanSteamGeneratorFBMiniOutput();
        ...
        for (let model of this.loadedJobSizingData.sizingOutput.outputGrid.outputGridRows) {
          ...
          row = new CleanSteamGeneratorFBMiniOutput();
...
showJobLoadError() {
  ...
  */
  onCalculateSizing(formGroup: FormGroup) {
    ...
    this.cleanSteamGeneratorFBMiniService.sizeCleanSteamGeneratorFBMini(this.csgProcessConditions).subscribe((CleanSteamGeneratorFBMiniOutputData: Array<CleanSteamGeneratorFBMiniOutput>) => {

      //check for csg ranges
      if (CleanSteamGeneratorFBMiniOutputData[0] == null) {
        return;
      }
      ...
      this.csgOutputData = CleanSteamGeneratorFBMiniOutputData.sort((a, b) => a.overdesign > b.overdesign ? 1 : 0);
  ...
  setupDefaultOptionsForSizingSelection(selectedRow: CleanSteamGeneratorFBMiniOutput) {
  ...
  */
  validateFormControlInput(control: AbstractControl, controlName, unitRef, msgRef) {
    ...
    if (control.value !== "") {
      ...
      var csgInputValidation: CleanSteamGeneratorFBMiniInputValidation = new CleanSteamGeneratorFBMiniInputValidation();
      ...
      this.cleanSteamGeneratorFBMiniService.validateCleanSteamGeneratorFBMiniInput(csgInputValidation).subscribe((result: Array<CleanSteamGeneratorFBMiniValidationMessage>) => {
  ...
  */
  validateProcessConditions(): void {
    ...
    if (this.plantsteampressure.value != "" && this.cleansteampressure.value != "") {
      var csgInputsValidation: CleanSteamGeneratorFBMiniProcessConditionsValidation = new CleanSteamGeneratorFBMiniProcessConditionsValidation();
      ...
      this.cleanSteamGeneratorFBMiniService.validateCleanSteamGeneratorFBMiniProcessConditions(csgInputsValidation).subscribe((result: Array<CleanSteamGeneratorFBMiniValidationMessage>) => {
  ...
  */
  ...
  onGetTiSheet() {
    ...
    tiRequestModel.moduleId = 11; // CSG ModuleId is 11 (child, Product Sizing), moduleGroupId=13 (parent)
  ...
  onPdfSubmit() {
    ...
    this.csgFbMiniDocGenService.getcsgFbMiniPdf(this.docGen)
  ...
  get csgOutputDataRows(): CleanSteamGeneratorFBMiniOutput[] {
   ...
   */
  onSelect(event: any) {
    var selectedRow = event.selected as CleanSteamGeneratorFBMiniOutput[];
...
//    this.storeCurrentlySelectedOptionItemValues();
   ...
   */
  selectCSGOutputDataRow(selectedRow: CleanSteamGeneratorFBMiniOutput) {
  ...
  calculatePrice() {
    ...
    this.cleanSteamGeneratorFBMiniService.calculateTotalPrice(this.csgPricing).subscribe((response: CleanSteamGeneratorFBMiniPricingOutput) => {
  ...
  */
  ...
  augmentPriceDataToOptionsLists() {
    ...
    this.cleanSteamGeneratorFBMiniService.calculateBOMPrice(this.csgPricing).subscribe((response: CleanSteamGeneratorFBMiniBOMPriceOutput) => {
      if (response) {

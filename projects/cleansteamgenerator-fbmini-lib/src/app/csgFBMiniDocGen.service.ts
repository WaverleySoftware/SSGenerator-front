...
@Injectable()
export class csgFbMiniDocGenService {

  constructor(private http: HttpClient) {

  }

  getcsgFbMiniPdf(docGen: DocGen) {
    ...
    this.http.post<any>('./Api/reports/csgfb/DocGen/CacheModel', docGen).subscribe(response => {

      var sessionId = response.sessionId;

      window.open('./Api/reports/csgfb/DocGen/ReportViewer?id=' + sessionId);
